...
<?php require "../htmls/header.php" ?>
    ...
    <h1 class="display-5 fw-bold">Лучший проект за 2100 г.</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">Gacho-Inc. самый продвигаемая студия за последнюю сотню лет! Миллионы клиентов состоят в своих dungeon с нашими Bondage. Заказывая Bondage с Billy support, вы получаете эксклюзивную фигурку billy.</p>
    </div>
  </div>
<div class="px-4 py-5 text-center border-bottom">
    <h1>Отзывы</h1>
    <div class="col-lg-6 mx-auto">
        <p class="lead mb-4">Тысячи дискорд серверов состоят в наших рядах увожаемых slaves. Не проходите мимо! Присоединяйтесь, dungeon не ждет!</p>
    </div>
</div>
